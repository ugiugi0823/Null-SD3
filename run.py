...
def main(args):
    ...
    # with open('./pickle/att/x_t_p2.pkl', 'wb') as f:
    #     pickle.dump(x_t, f)
        
    # with open('./pickle/att/uncond_embeddings_p2.pkl', 'wb') as f:
    #     pickle.dump(uncond_embeddings, f)

    # with open('./pickle/att/uncond_embeddings_p_p2.pkl', 'wb') as f:
    #     pickle.dump(uncond_embeddings_p, f)
    


    
    # with open('./pickle/att/x_t_p2.pkl', 'rb') as f:
    #     x_t = pickle.load(f)
    
    # with open('./pickle/att/uncond_embeddings_p2.pkl', 'rb') as f:
    #     uncond_embeddings = pickle.load(f)
        

    # with open('./pickle/att/uncond_embeddings_p_p2.pkl', 'rb') as f:
    ...
    prompts = ["photo of a crack defect image",
            "photo of a crack red image"]
    neg_prompts = [neg_prompt, neg_prompt] 

    cross_replace_steps = {'default_':1.0,}
    self_replace_steps = 0.4
    blend_word = ((('defect',), ("red",))) 
